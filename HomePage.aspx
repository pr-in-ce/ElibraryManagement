    ...
    <section>
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-4">
                    <center>
                        <img width="80px" src="imgs/digital-inventory.png" />
                ...
                <div class="col-md-4">
                    <center>
                        <img width="80px" src="imgs/search-online.png" />
                        <h4>Search Books</h4>
                        <p class="text-justify">Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Lorem ipsum dolor. reprehenderit</p>
                    </center>
                </div>
                ...
                <div class="col-md-4">
                    <center>
                        <img width="80px" src="imgs/defaulters-list.png" />
    ...
    <section>
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-4">
                    <center>
                        <img width="80px" src="imgs/sign-up.png" />
                        <h4>Sign Up</h4>
                        <p class="text-justify">Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Lorem ipsum dolor. reprehenderit</p>
                    </center>
                </div>
                ...
                <div class="col-md-4">
                    <center>
                        <img width="80px" src="imgs/library.png" />
                        <h4>Visit Us</h4>
                        <p class="text-justify">Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Lorem ipsum dolor. reprehenderit</p>
                    </center>
                </div>
